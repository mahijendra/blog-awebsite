...
const BlogDisplay = ({ id, title, content, thumbnailUrl, author, setEditing, setBlogs, blogs, blog }) => {
    ...
    return (
        <div className='blogDisplay'>
           ...
           {/* <button onClick={() => deleteUser(blog.id)} className='blog__delete'>Delete Blog</button>*/}
